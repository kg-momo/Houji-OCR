...
parser.add_argument('--trained_model', default='finetune_3dats_4b_10000epoch.pth', type=str, help='pretrained model')
...
#double_score_comb
parser.add_argument('--double_score_comb', default=False, action='store_true', help='enable double_score_comb')
parser.add_argument('--show_time', default=False, action='store_true', help='show processing time')
parser.add_argument('--test_folder', default='/data/', type=str, help='folder path to input images')
parser.add_argument('--refine', default=False, action='store_true', help='enable link refiner')
parser.add_argument('--resultf', default='./result/',  help='')
...
result_folder =  args.resultf #'./result/'
...
def test_net(net, image, text_threshold, link_threshold, low_text, cuda, poly, refine_net=None):
    ...
    # resize
    img_resized, target_ratio, size_heatmap = imgprocinv.resize_aspect_ratio(image, args.canvas_size, interpolation=cv2.INTER_LINEAR, mag_ratio=args.mag_ratio)
    ...
    # Post-processing
    boxes, polys = craft_utilsg.getDetBoxes(score_text, score_link, text_threshold, link_threshold, low_text, poly, args.double_score_comb)
...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        bboxes, polys, score_text,score_link = test_net(net, image, args.text_threshold, args.link_threshold, args.low_text, args.cuda, args.poly, refine_net)


        # save score text
        filename, file_ext = os.path.splitext(os.path.basename(image_path))
        mask_file = result_folder + "/res_" + filename + '_mask.jpg'
        mask_file2 = result_folder + "/res_" + filename + '_aff_mask.jpg'
